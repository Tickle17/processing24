      ...
      <div className="oWMainInfo">
        ...
        <div className="mainInfoOW">
          ...
          <div className="miBody">
            ...
            <div className="miBodyInfo">В назначенное время приедет заправщик и заправит автомобиль топливом.</div>
            <div className="miBodyInfo2">Если у заказчика есть действующий договор на топливные карты, то при оплате можно провести транзакцию через терминал. Переносное устройство есть у каждого заправщика</div>
          </div>
        </div>
      </div>
    </div>
